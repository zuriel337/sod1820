...
with base as (
  ...
  select b.*,
    ...
    case
      ...
      -- Preserve the practical legacy WarRoom working window rather than exposing the whole archive.
      ...
      -- WhatsApp remains fully browsable, but only a small recent unanswered window joins "דורש אותי".
...
begin
  ...
  loop
    ...
    -- For sources the legacy WarRoom understands, write its canonical attention marker so both UIs stay synced.
