...
with admin_ok as (
  ...
  -- Replies/comments across forum, number, ELS, community, Beit Midrash, etc.
  ...
  union all
  -- Human research contributions that are not comments. Auto/system imports are excluded.
  ...
  union all
  -- Human/source channel material only; system/admin/AI broadcasts are history, not incoming attention.
