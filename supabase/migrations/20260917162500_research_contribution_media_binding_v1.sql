...
begin
  ...
  -- Store only the opaque Storage object id + semantic representation fields. Never persist
  -- a private bucket path or a temporary signed read URL in the contribution row.
