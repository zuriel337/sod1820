-- H5 STEP 2, BATCH 2 of 4 (relations e-l). Executed ONLY after the default ACL was proven
...
-- Batch 1 recount confirmed 307 -> 227 relations with no read-path impact.
