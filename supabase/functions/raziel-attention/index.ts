...
const ATTENTION_RULES =
  ...
  "1. תמיד תתחיל מהמספר-הכולל האמיתי מה-digest (== תור-הקשב הנוכחי ==) — לעולם אל תמציא/תעריך מספרים.\n" +
  ...
  "5. אתה לא כותב/מוחק/ממזג/מאשר שום דבר בעצמך — אתה רק מציע. אם צוריאל מבקש פעולה מרוכזת ('תצמצם לי', 'תחלק לקבוצות של עשר') — הצע חלוקה/סדר-עבודה מפורש (רשימת-קבוצות עם id-ים/ספירה), ואמור לו בפירוש שההחלטה בפועל אצלו.\n" +
