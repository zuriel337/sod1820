...
| Research Plan / capability selection / Temporal World Model / evidence-aware AI research | `research_strategy_layer_law` | versioned rule | **v11 ACTIVE · DB-LIVE 2026-09-14** | v11 is the current cumulative Research Strategy owner. It preserves prior Anchor Strength/Emergence semantics and adds governed pattern/sequence research, source snapshot/current-render honesty, coordinate/span dependency and selection-protocol provenance, negative/incomplete outcomes, evidence independence before ranking, multi-axis time/history, contextual Rank != Truth, and authorized Personal/Cohort constellation discovery. Read only the live v11 body for current semantics; older v5–v10 are provenance/history, not current routing authority |
