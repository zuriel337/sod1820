...
|---|---|---|---|---|
| One Reality Graph / One Tree identity + relations | `reality_graph_law` | versioned rule + codex | **v5 ACTIVE · DB-LIVE 2026-09-14** | `nodes/edges`; v5 owns qualified Research Anchors, Number/Expression/Concept separation, typed relations, dynamic clusters and projection semantics; no parallel graph/store |
...
| Research Plan / capability selection / Temporal World Model / evidence-aware AI research | `research_strategy_layer_law` | versioned rule | **v12 ACTIVE · DB-LIVE 2026-09-14** | v12 is the current cumulative Research Strategy owner. It preserves v11 and all prior Anchor Strength/Emergence, pattern/sequence, source-state, temporal/history, evidence-independence and Personal/Cohort semantics, and adds context-gated secondary hint research: a qualified primary Anchor/Constellation may open bounded weak-operator expansion; Anchor Strength controls search radius rather than truth; secondary hints cannot create primary significance; search-space/selection provenance, anti-noise budgets, dependency grouping, Explain-Why and primary-vs-secondary projection remain explicit. Read only the live v12 body for current semantics; v5–v11 are provenance/history, not current routing authority |
