...
| Research Plan / capability selection / Temporal World Model / evidence-aware AI research | `research_strategy_layer_law` | versioned rule | **v4 ACTIVE · DB-LIVE 2026-09-13** | v4 preserves v3 and adds explainable Anchor Strength: exact-expression integrity, source attestation/provenance, anti-match-count gaming, evidence independence, lineage, cross-domain coherence, contradiction/control state and Human curation. Strength/Rank never becomes Truth or Governance and no parallel score/store is created |
