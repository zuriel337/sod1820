export const BUILD_TRACKS = [
  {
    ...
    summary:"האתר נבנה מחדש כמסע מחקר אחד על גוף ידע אחד: אפשר להיכנס דרך מספר, נושא, זמן, מקור, אדם, פסוק, צופן או מסע — ולהחליף עדשה בלי לאבד את ההקשר.",
    metrics:["מסע רציף בין עולמות הידע","עדשות על אותו גוף ידע","חזרה לנקודת המחקר"],
    details:[
      "האתר הולך להרגיש הרבה פחות כמו אוסף עמודים והרבה יותר כמו יקום מחקר אחד: נכנסים דרך מספר, נושא, זמן, מקור, אדם או צופן וממשיכים בין הקשרים.",
      "אותו ידע יוכל להיפתח דרך עדשות שונות — למשל קשרים, נושאים, ציר זמן, מקורות ומסעות — בלי ליצור עותקים נפרדים של האמת.",
      "המטרה היא שתוכלו לחזור למחקר גם אחרי יום או שבוע, להיכנס אליו מנקודה אחרת בעץ ולהמשיך בלי לאבד את ההקשר."
    ]
  },
  {
    ...
    details:[
      ...
      "מסע מחקר יוכל להתחבר למספרים, נושאים, מקורות וממצאים שכבר קיימים בעץ — כך שאפשר יהיה לחזור אליו גם דרך נקודות אחרות שקשורות אליו."
    ]
  },
  {
    id:"numbers", icon:"🔢", label:"עולם המספרים והגימטריה", stage:3, status:"בבנייה",
    summary:"כל מספר הופך מציון חישוב לצומת ידע שמחבר ביטויים, פסוקים, אנשים, אירועים, צפנים, נושאים, זמן ומסעות מחקר.",
    ...
    details:[
      ...
      "דף המספר העתידי יהפוך למרכז חי: ידע מאומת, מחקר פתוח, קשרים, נושאים, מקורות, ציר זמן ומסעות — כולם על אותו גוף ידע.",
  ...
  },
  {
    ...
    summary:"שכבת החיבור של האתר: מספר ↔ מילה ↔ פסוק ↔ ספר ↔ צופן ↔ אדם ↔ אירוע ↔ נושא ↔ מסע. אותו עץ נפתח דרך עדשות שונות.",
    metrics:["5,967 צמתי ידע","5,174 קשרים","עץ אחד לכל המערכת","רזיאל = שכבת AI מלווה"],
    details:[
      "5,967 nodes ו-5,174 edges כבר קיימים בגרף הידע.",
      "מספר, נושא, זמן, מקור ומסע אינם מאגרי אמת נפרדים — הם דרכי כניסה ועדשות שונות על אותו גוף ידע, שנפתחות בהדרגה לפי מוכנות.",
      "רזיאל יהיה שכבת ה-AI שמבינה איפה אתם נמצאים ומציעה קשרים, עדשות והמשך חקירה על אותו עץ."
    ]
  },
  {
  ...
  },
  {
    ...
    summary:"ההיכל יהיה הדרך המרחבית להיכנס לאותו גוף ידע דרך מספרים, צפנים, ספרים, אנשים, נושאים, זמן ומסעות.",
    metrics:["היכל בבנייה","מסעות גילוי בקרוב","מסעות תלת־ממדיים בקרוב","גלקסיות ידע בקרוב"],
    details:[
      "ההיכל יהיה הדרך המרחבית להיכנס לאותם מספרים, צפנים, ספרים, אנשים, נושאים וקשרים שכבר שייכים לעץ האחד.",
      "מסע גילוי עתידי יוכל להיפתח מכמה נקודות קשורות באותו עץ — לא כעותק נפרד בכל דף.",
      "בהמשך: מסעות גילוי, מסעות תלת־ממדיים וגלקסיות ידע; הפתיחה תהיה בהדרגה לפי המוכנות האמיתית של כל אזור."
    ]
  }
];
...
export const KNOWLEDGE_WORLDS = [
  {
    ...
    publicCopy:"כאן מתחילים מהחומר שכבר חי באתר וממשיכים ממנו דרך נושאים, זמן, מספרים, מקורות ומסעות — כולם דרכי כניסה לאותו גוף ידע.",
    items:[
      ...
      {label:"מסעות גילוי",emoji:"🧭",locked:true,state:"בקרוב",note:"מסלולים שניתן יהיה לפגוש ולהמשיך מכמה נקודות קשורות בעץ"},
  ...
  },
  {
    ...
    publicCopy:"כל מספר נבנה כשער לאותו עץ: ביטויים, פסוקים, אנשים, אירועים, צפנים, נושאים, מקורות, זמן ומסעות — ובהמשך גם שכבות מרחביות.",
    items:[
      {label:"דף המספר",emoji:"🔢",to:"/number",note:"מספר → ידע → קשרים; שכבות המחקר החדשות נבנות בהדרגה"},
  ...
  },
  {
    ...
    publicCopy:"מספר ↔ מילה ↔ פסוק ↔ ספר ↔ צופן ↔ אדם ↔ אירוע ↔ נושא. אותו גוף ידע ייפתח בהדרגה דרך מספר, נושא, זמן, מקור ומסע — ורזיאל ילווה בין הקשרים.",
    items:[
  ...
  },
  {
    ...
    publicCopy:"הארכיון הופך מאוסף כרונולוגי לרשת כניסות לפי זמן, מספר, פסוק, צופן, אדם ונושא. בהמשך אותה כרונולוגיה תוכל להיפתח גם מתוך ישות או מסע מחקר, בלי להעתיק את התוכן.",
    items:[
      ...
      {label:"לפי מסעות",emoji:"🧭",locked:true,state:"בקרוב",note:"כניסה למסלול מחקר מאושר מכמה נקודות קשורות בעץ"}
    ]
  },
  {
  ...
  },
  {
    ...
    publicCopy:"ההיכל אינו מערכת נפרדת: הוא יהיה חוויית הכניסה המרחבית לאותם מספרים, צפנים, ספרים, אנשים, נושאים, זמן ומסעות שעל העץ האחד.",
    items:[
      {label:"היכל",emoji:"🏛️",locked:true,state:"בשיפוץ",note:"נפתח בהדרגה לפי מוכנות"},
      {label:"מסעות גילוי",emoji:"🧭",locked:true,state:"בקרוב",note:"מסלולים מודרכים בין קשרים, עם כניסות ממספר נקודות בעץ"},
