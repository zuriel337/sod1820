...
// 🔒 ELS נכנס לבנייה מחדש (Human Gate ZURIEL, 10.9.2026).
// false → הציבור רואה מצב "בבנייה מחדש" גם בהיכל; אדמין ממשיך לקבל את המנוע הממומש דרך IMPLEMENTED_TOOLS.
// זהו mirror-compatibility של מימוש ה-ready הוותיק. מצב-היכולת הקנוני החדש נרשם גם ב-site_flags.lock_els
// תחת site_flags_lock_law; אין ליצור מנוע ELS נוסף ואין למחוק את המנוע הקיים.
...
// (החלטת צוריאל 7.2026). המנהל ממשיך לעבוד על כל הכלים הממומשים (READY_LAB כולל אותם דרך isToolReady). כשנפתח לציבור —
