...
export async function getRecentCommunityWords(limit = 4) {
  ...
  const sel = 'phrase, ragil, misratar, gadol, miluy, kadmi, ribua, created_at, visibility_changed_at, source, vip_source, tags, is_verified, is_published, category, dna_status';
