...
// מילוי גדול (miluy_gadol_def): מילוי עם אות-סופית באיות בערך גדול (מ→מ"ם 40+600, כ→כ"ף 20+800, א→אל"ף 1+30+800…). יום משיח=2770=עזר×10.
const MILUI_GADOL = { "א": 831, "ב": 412, "ג": 83, "ד": 434, "ה": 15, "ו": 22, "ז": 717, "ח": 418, "ט": 419, "י": 20, "כ": 820, "ך": 820, "ל": 74, "מ": 640, "ם": 640, "נ": 756, "ן": 756, "ס": 600, "ע": 780, "פ": 81, "ף": 81, "צ": 104, "ץ": 104, "ק": 906, "ר": 510, "ש": 1010, "ת": 416 };
...
export const DEPTH_METHODS = [
  ...
  { key: "מילוי גדול", tag: "hebrew", soul: "מילוי עם אותיות סופיות בערך גדול", fn: w => sumBy(w, MILUI_GADOL) },
...
const LMAP = { "רגיל": GEM, "מילוי": MILUI, "מילוי גדול": MILUI_GADOL, "קדמי": KID, "סידורי": ORD, "אתבש": ATB, "אלבם": ALB, "אטבח": ATBACH, "הכפלה": SQR, "הכפלה גדולה": SQR_GADOL, "משולש גדול": KID_GADOL, "מילוי דמילוי": MDM, "מילוי דמילוי גדול": MDM_GADOL };
