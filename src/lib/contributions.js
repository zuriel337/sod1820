  ...
  if (wantContrib) {
    tasks.push((async () => {
      ...
      return rows.map(c => ({
        ...
        target_type: c.target_type, target_id: c.target_id, title: c.title, body: c.body, image_url: c.image_url || null, reactions: c.reactions, reaction_boosts: c.reaction_boosts || {},
