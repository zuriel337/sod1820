...
export const ROUTE_META = {
  ...
  "/":              { fullTitle: "כי לה' המלוכה — סוד 1820 · לגלות את המציאות בשפת המספרים", title: "כי לה' המלוכה — סוד 1820", description: "מחקר חי של מספרים, גימטריה, צפנים בתורה, קוד המציאות, מקורות ומסעות גילוי — מערכת SOD1820 מחברת בין מספרים, מילים, פסוקים, אנשים ואירועים." },
