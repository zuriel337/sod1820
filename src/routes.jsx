...
export const ROUTE_META = {
  "/":              { fullTitle: "כי לה' המלוכה · SOD1820 — רמזי הגאולה בשפת המספרים", title: "כי לה' המלוכה", description: "אתר כי לה' המלוכה · SOD1820 — רמזי הגאולה הגדול בעולם. 14 שנות מחקר: גימטריה, עץ המספרים, מאגר חי של צפנים, חידושי AI וכלים לקריאת המציאות בשפת המספרים." },
  ...
  "/journey":       { title: "מסע הגילוי", description: "מסע אישי בין מספרים ומילים — מהמושג הראשוני ועד ההתכנסות המפתיעה, כל צעד מקושר לעץ הידע." },
  "/מסע":           { title: "מסע הגילוי", description: "מסע אישי בין מספרים ומילים — מהמושג הראשוני ועד ההתכנסות המפתיעה, כל צעד מקושר לעץ הידע." },
