...
// דף המספר · דילוגי אותיות — מוצרים ציבוריים בסרגל הישן. «היכל» = הכניסה לכלים,
...
// הלוגו מוביל הביתה — לכן «בית» אינו קישור נפרד. World נשאר נגיש ישירות אך אינו מקודם מהסרגל הישן.
...
// 🏛️ תפריט-מגה אופקי של «היכל» — נפתח בריחוף, מציג את כלי המעבדה בשורה (מאוזן, לא מאונך).
// ⚠️ אין לכפול כאן את שלושת המוצרים הקנוניים (דף-המספר · בית-המדרש · דילוגי-אותיות) — הם כבר
// יושבים כצ'יפים לצד «ההיכל» בשורה הראשית (עם יעד קנוני /number · /world · /code).
