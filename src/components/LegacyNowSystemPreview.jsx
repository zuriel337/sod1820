  ...
  return (
    <section className="sod-now-preview" aria-label="הצצה מהמערכת החדשה — העת עכשיו">
      ...
      <div className="sod-now-map">
        <span className="pipe p1" /><span className="pipe p2" /><span className="pipe p3" />
        <span className="pipe p4" /><span className="pipe p5" /><span className="pipe p6" />

        <div className="node year"><small>השנה</small><strong>תשפ״ז = 787</strong></div>
        <div className="node ronen"><small>אבני רונן</small><strong>ושמחת בחגך = 787</strong></div>

        <Link to="/yam-hamelach-tiferet-geula" className="diamond">
        ...
        <div className="locked l1">● עוד גימטריות 🔒</div>
        <div className="locked l2">● מקורות 🔒</div>
        <div className="locked l3">● צירים 🔒</div>
        <div className="locked l4">● חיבורים נוספים 🔒</div>
      </div>
      ...
      <style>{`
        ...
        .diamond{position:absolute;z-index:4;left:50%;top:52%;transform:translate(-50%,-50%) rotate(45deg);width:122px;height:122px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-decoration:none;border:1px solid rgba(212,175,55,.8);background:linear-gradient(145deg,rgba(212,175,55,.18),rgba(62,166,255,.10),rgba(9,6,3,.96));box-shadow:0 0 34px rgba(212,175,55,.2)}
        .diamond>*{transform:rotate(-45deg)}.diamond small{color:${C.goldDim};font:700 8px ${F.heading}}.diamond strong{color:${C.goldBright};font:800 13px ${F.body};white-space:nowrap}.diamond b{color:${C.goldBright};font:900 22px ${F.mono}}.diamond em{color:${C.goldLight};font:700 8px ${F.heading};font-style:normal;margin-top:5px}
        .node{position:absolute;z-index:3;padding:8px 10px;border:1px solid rgba(212,175,55,.24);border-radius:11px;background:rgba(12,8,4,.9)}.node small{display:block;color:${C.goldDim};font:700 8px ${F.heading}}.node strong{display:block;color:${C.goldLight};font:800 11px ${F.body};white-space:nowrap}.node.year{top:18px;right:12px}.node.ronen{top:18px;left:12px}
        .locked{position:absolute;z-index:2;color:${C.goldDim};font:700 8px ${F.heading};opacity:.65}.l1{bottom:52px;right:14px}.l2{bottom:20px;right:70px}.l3{bottom:20px;left:70px}.l4{bottom:52px;left:14px}
        .pipe{position:absolute;z-index:1;left:50%;top:52%;height:1px;width:132px;transform-origin:0 50%;background:linear-gradient(90deg,rgba(212,175,55,.08),rgba(212,175,55,.55),rgba(62,166,255,.18));box-shadow:0 0 8px rgba(212,175,55,.2)}.p1{transform:rotate(-52deg)}.p2{transform:rotate(232deg)}.p3{transform:rotate(33deg)}.p4{transform:rotate(147deg)}.p5{transform:rotate(72deg)}.p6{transform:rotate(108deg)}
        ...
        @media(max-width:560px){.sod-now-map{height:286px}.diamond{width:108px;height:108px}.node{padding:7px 8px}.node strong{font-size:10px}.locked{font-size:7px}}
      `}</style>
    </section>
  );
}
