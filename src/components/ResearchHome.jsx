...
export const TOOLS = [
  ...
  { id: "christina", icon: "🔤", cat: "engine", title: "מנוע כריסטינה — פירוק ומילוי", desc: "שתי העדשות של כריסטינה, זו לצד זו: פירוק-האותיות (משמעות פרשנית לכל אות) ומחשבון-המילוי בשיטתה הקבועה (ו=וו=12). הקלידו מילה — ותקבלו את שתיהן.", status: "live" },
  ...
  { id: "journey", icon: "🧭", cat: "tool", title: "מסע החיים (יסוד)", desc: "הזהות שלכם ובני משפחתכם — פרטי לגמרי, נשמר בענן. השלב הראשון של מסע-חיים אמיתי: מי אני, מי המשפחה שלי.", status: "live" },
