...
// «🟢 מישהו בודק מספר · 🟣 מישהו בפסוקים · 🔵 מישהו מריץ דילוגים» + «⚡ N פעילים עכשיו».
// מקור: RPC activity_pulse (ספירות-בלבד, אפס תוכן). המערכת מרגישה נושמת — והפרטיות שמורה.
const TYPES = [
  { key: "numbers",  dot: "#57c98a", e: "🔢", label: "מישהו בודק מספר" },
  { key: "names",    dot: "#e8c84a", e: "🔤", label: "מישהו בודק שם או ביטוי" },
  ...
  { key: "els",      dot: "#57a9e8", e: "🔠", label: "מישהו מחפש בצופן התנכי" },
  { key: "journeys", dot: "#ff9b6b", e: "🧭", label: "מישהו יצא למסע" },
  { key: "research", dot: "#e0779b", e: "🔬", label: "מישהו לומד בהיכל" },
];
