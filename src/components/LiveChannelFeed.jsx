...
import { useSiteUpdates, openSiteUpdates, closeSiteUpdates } from "../lib/siteUpdates.js";
...
export default function LiveChannelFeed({ hideFab = false }) {
  ...
  // כדי שגם ה-Bottom Bar (וכל מקום אחר בעתיד) יוכל לפתוח/לסגור בדיוק את אותו חלון קיים.
