  ...
  return (
    <>
      <style>{`
        ...
        .lcf-head .ava{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#e8c15a,#b98f2e);display:grid;place-items:center;font-size:19px;flex:0 0 auto}
        ...
        <>
          ...
          <aside className={"lcf-panel" + (docked ? " docked" : "")} role={docked ? "complementary" : "dialog"} aria-label="עדכונים חיים">
            <div className="lcf-head">
              ...
              <div><div className="nm">סוד1820 · עדכונים חיים</div><div className="st"><i />מחובר · עכשיו</div></div>
