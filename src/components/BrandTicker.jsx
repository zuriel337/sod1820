...
// 🌅 הלוגו המקורי של «אור הגאולה» (זה שבמרכז השידורים) — מקור-אמת יחיד. מחליף את סמל-השמש/🎬
// בכל מקום: דף אור-הגאולה, הרצועה בבית, צ'יפ-הסטורי, ובתוך הסרטונים (StoryViewer). עץ אחד — לא לשכפל URL.
export const OR_GEULA_LOGO = BRANDS["or-geula"].logo;
    ...
    <div style={{ direction: "rtl", marginBottom: 10 }}>
      ...
      <div style={{ background: b.bg, border: `1px solid ${b.accent}55`, borderRadius: 14, padding: "9px 12px 11px",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 8 }}>
          ...
          {/* תקן שידור מקצועי: ● LIVE אדום מהבהב + אייקון וואטסאפ (מקור) — אפס מילים */}
          <span style={{ flex: "0 0 auto", display: "inline-flex", alignItems: "center", gap: 5, background: "#c8102e",
            color: "#fff", fontFamily: F.heading, fontWeight: 900, fontSize: 9.5, letterSpacing: 1.5,
          ...
          {!b.site && (b.wa ? (
            ...
            <span title="המקור: וואטסאפ" style={{ flex: "0 0 auto", display: "inline-flex", alignItems: "center", justifyContent: "center",
