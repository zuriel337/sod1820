...
const TIERS = [
  ...
  },
  {
    ...
    items: [
      { emoji: "🏛️", title: "מרכז המחקר", to: "/research", desc: "כל כלי-המחקר במקום אחד — מחשבון, דף-מספר, חיפוש-פסוקים, דילוגים ובית-המדרש.", badge: "חדש" },
  ...
  },
  {
    ...
    items: [
      ...
      { emoji: "📚", title: "בית המדרש", to: "/research?tool=midrash", desc: "ללמוד את שיטות הגימטריה לעומק — בתוך מרכז המחקר." },
    ],
  },
  {
