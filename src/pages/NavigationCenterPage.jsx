...
const TIERS = [
  ...
  },
  {
    ...
    items: [
      { emoji: "🏛️", title: "היכל הגילוי", to: "/research", desc: "כל כלי-המחקר במקום אחד — מחשבון, דף-מספר, חיפוש-פסוקים, דילוגים ובית-המדרש.", badge: "חדש" },
      { emoji: "🧮", title: "מחשבון הגימטריה", to: "/research?tool=gematria", desc: "17 שיטות + מנועי עומק. חינם לכולם.", badge: "חינם" },
  ...
  },
  {
    ...
    items: [
      ...
      { emoji: "🔍", title: "הצופן התנ\"כי (דילוגים)", to: "/code", desc: "דילוגי אותיות + מובהקות סטטיסטית — עדות, לא ניבוי." },
      { emoji: "📚", title: "בית המדרש", to: "/research?tool=midrash", desc: "ללמוד את שיטות הגימטריה לעומק — בתוך היכל הגילוי." },
    ],
  },
  {
