...
// 🖼 «סטים מסוננים» לגלריה — מספר שכדאי להציג במאגר עם סט-מספרים קשור, לא רק הוא לבדו.
// 45 (דוד המלך · אדם · מה) מוצג יחד עם 14 (דוד) — «סט 14+45» הקלאסי. ניתן להרחיב בעתיד.
const NUMBER_GALLERY_SETS = { 45: [14, 45] };
