...
const METHOD_INFO = {
  ...
  "מילוי גדול": { what: "מילוי עם אותיות סופיות בערך גדול.", how: "כמו מילוי (איות שם האות), אך אות סופית בתוך האיות מקבלת ערך גדול: מ→מ״ם (40+600) · כ→כ״ף (20+800) · א→אל״ף (1+30+800). למשל יום משיח = 2770.", insight: "💎 «יום משיח» במילוי גדול = 2770 = «עזר» (277) ×10." },
  ...
  return (
    <div>
      ...
      <p style={{ color: L.sub, fontFamily: F.body, fontSize: 15, lineHeight: 1.9, margin: "0 0 20px", maxWidth: 620 }}>
        כל שיטה חושפת רובד אחר באותו ביטוי. הנה כל 21 שיטות החישוב, עם הסבר ודוגמה חיה (על המילה <b style={{ color: L.goldDeep }}>{SAMPLE}</b>).
      </p>
