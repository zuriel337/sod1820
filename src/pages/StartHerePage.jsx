...
const STEPS = [
  ...
  { tier: "🫀 הלב", emoji: "🏛️", title: "היכל — כל הכלים במקום אחד", badge: "חדש",
    body: "מחשבון גימטריה (20 שיטות · חינם), דף-המספר, חיפוש בפסוקים, דילוגי-אותיות והעולם — סביבת-מחקר אחת שנשארת פתוחה לאורך כל המסע.",
  ...
  { tier: "👑 ההצטרפות", emoji: "👑", title: "הצטרפו לבני ההיכל",
    ...
    how: "המחשבון והעולם פתוחים לכולם חינם. «בני ההיכל» נותן את השכבה המתקדמת — כלים בלעדיים, צפנים והתגלויות חדשות שממשיכות להתווסף.",
    to: "/members" },
];
  ...
  return (
    <div style={{ direction: "rtl", maxWidth: 880, margin: "0 auto", padding: "64px 24px 96px", position: "relative", zIndex: 1 }}>
      ...
      <p style={{ color: P.accentDim, fontFamily: F.body, fontSize: 17, lineHeight: 2, textAlign: "center", maxWidth: 640, margin: "-24px auto 32px" }}>
        ...
        <br />
        <span style={{ color: P.accentText }}>המחשבון והעולם פתוחים לכולם, חינם.</span>
      </p>
      ...
      <div style={{ textAlign: "center", marginTop: 48 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginTop: 20 }}>
          <GoldButton to="/gematria" variant="secondary">פתחו את המחשבון →</GoldButton>
