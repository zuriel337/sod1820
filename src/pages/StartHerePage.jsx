...
const STEPS = [
  ...
  { emoji: "🕰", title: "מהו ציר התדר", body: "ציר הזמן של אירועי הגאולה. כל תחנה מתעדת אירוע — ולצידו הפוסט, הסרטון, הצופן, מספרי האם והתגובות. כך כל אירוע הופך לעולם שלם של רמזים.", to: "/timeline" },
