...
const PUBLIC_BUILD_TRACKS = [
  ...
  { icon:"🧠", label:"מרכז מחקר אישי", stage:3, status:"בבנייה", details:[
    ...
    "במקום לפתוח עשר לשוניות, יהיה מקום אחד שבו רואים מה מצאתם, מה כבר נבדק, ומה עדיין מחכה להמשך.",
    "יהיה אפשר לעבור מתוצאה בודדת לתמונה רחבה: כמה מקורות מדברים על אותו רעיון, אילו מספרים חוזרים, ואילו קשרים נפתחים משם."
  ] },
  { icon:"🔢", label:"עולם המספרים והגימטריה", stage:3, status:"בבנייה", details:[
    "דף המספר יהפוך למרכז חי: ביטויים, פסוקים, אנשים, אירועים, שנים, צפנים וקשרים שנפגשים סביב אותו מספר.",
    "מחשבון הגימטריה לא יהיה רק «תוצאה = מספר», אלא נקודת כניסה לעוד שיטות חישוב, משפחות מילים, השוואות וגילויים.",
    "תוכלו לבחור מספר ולראות איך הוא חוזר בשכבות שונות של האתר, ואז לקפוץ ישר למחקר שמעניין אתכם."
  ] },
  { icon:"🔠", label:"צפנים בתורה · ELS", stage:3, status:"בבנייה", details:[
    "יהיה מנוע דילוגי אותיות מתקדם שבו תוכלו לחפש מילה או צירוף בתורה או בכל התנ״ך, ואז לבדוק מה מופיע סביבם.",
    "תוכלו לבצע חיפושים מוצלבים, להשוות מרחקים, לשמור מטריצות ולחזור לצופן שמצאתם גם בהמשך.",
    "הצפנים לא יישארו רק טבלה שטוחה: יהיו תצוגות דו־ממד, שכבות ותלת־ממד שיאפשרו להסתובב בתוך המטריצה ולראות מבנים וקשרים בצורה חזותית.",
    "מצאתם צופן חזק? תוכלו לחבר אותו למספר, לפסוק, לאירוע, לאדם או למקור אחר באתר ולהמשיך משם."
  ] },
  { icon:"📚", label:"ספרים, כתבי־יד ומקורות", stage:2, status:"מתחבר למערכת", details:[
    "אנחנו בונים ספרייה מחקרית שבה ספרים ומקורות לא יהיו רק PDF או טקסט לקריאה — אלא חומר שאפשר לחפש, לסמן ולחבר לממצאים אחרים.",
    "אהבת תורה וספר הפליאה הם רק ההתחלה. בהמשך יוכלו להיכנס עוד ספרים, מאמרים, כתבי־יד ומקורות מחקריים.",
    "תוכלו לחפש רעיון אחד לרוחב כמה מקורות, לראות איפה הוא מופיע, ולעבור ישירות מהקטע בספר למספר, פסוק או צופן שמתחבר אליו.",
    "המטרה היא להפוך את ארון הספרים לחלק חי מהמנוע, ולא למדף נפרד."
  ] },
  { icon:"🌳", label:"עץ הידע + רזיאל", stage:2, status:"מתחבר למערכת", details:[
    "עץ הידע יראה לכם איך דברים מתחברים: מספר אל פסוק, פסוק אל אדם, אדם אל אירוע, אירוע אל צופן, וצופן אל מקור נוסף.",
    "רזיאל יהיה הבוט־החוקר שילך איתכם בתוך האתר. במקום שתצטרכו לדעת באיזה כלי להשתמש, תוכלו לשאול אותו מה אתם מחפשים והוא יעזור לפתוח את המסלול המתאים.",
    "הוא יוכל להציע כיווני חקירה, להראות מה עוד קשור למה שמצאתם ולהוביל אתכם מממצא אחד לממצא הבא.",
    "המטרה היא להרגיש שיש איתכם מדריך בתוך הספרייה והמעבדה — לא עוד תיבת צ׳אט בצד."
  ] },
  { icon:"🌍", label:"עברית, אנגלית ושפות נוספות", stage:2, status:"תשתית קיימת", details:[
    "אותו מחקר יוכל להיפתח בהמשך גם באנגלית ובשפות נוספות בלי לבנות אתר נפרד לכל שפה.",
    "יהיה אפשר לגלות קשרים בין מילים ושמות משפות שונות ולראות איך הם נפגשים דרך מספרים, צלילים ומשמעות.",
    "שתי העדשות — «כי לה׳ המלוכה» ו«קוד המציאות» — ימשיכו להציג את אותו גוף ידע בשפה שמתאימה לקהל."
  ] },
  { icon:"🏛️", label:"היכל חדש + מסעות גילוי", stage:2, status:"בשיפוץ", details:[
    "ההיכל יהפוך לשער ברור לכל כלי המחקר: מספרים, גימטריה, צפנים, מקורות ומסעות — בלי ללכת לאיבוד.",
    "יהיו מסלולים מוכנים למי שרוצה רק לגלות משהו מעניין, ולצדם כלים עמוקים למי שרוצה להיכנס למחקר אמיתי.",
    "במובייל ובמחשב החוויה תיבנה מחדש כך שהדרך בין תוכן, כלי מחקר ותוצאה תהיה הרבה יותר קצרה.",
    "הפתיחה תהיה בהדרגה: כל חלק שיעבור את שלב הבנייה ייפתח לציבור בלי לחכות שכל המערכת תושלם."
  ] },
];
