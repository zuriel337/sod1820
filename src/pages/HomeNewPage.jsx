...
export default function HomeNewPage() {
  ...
  return (
    <div ref={homeRef} style={{ direction: "rtl", minHeight: "100vh", background: rootBg, color: P.ink }}>
      ...
      {/* ===== 🎬 אור הגאולה — הורד מלמעלה לתחתית העמוד (בקשת צוריאל 13.8.2026); הרצועה עצמה למטה ===== */}
      ...
      {/* ===== 🎬 אור הגאולה — הורד לתחתית העמוד (בקשת צוריאל 13.8.2026): לא הוסר, רק ירד מלמעלה ===== */}
      <section className="hn-wrap" style={{ padding: "8px 18px 12px" }}>
        <HomeOrGeulaRail />
      </section>
