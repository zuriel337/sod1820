...
### World full-corpus catalog — DONE / LIVE

World now exposes the complete public Convergence corpus through the existing canonical Topic reader:
- exact total;
- server pagination in pages of 24;
- title/description search;
- creator filter;
- real crawlable links to `/topic/:slug`;
- “מה חדש” remains freshness and “התכנסויות בולטות” remains discovery; “כל ההתכנסויות” is the full canonical catalog.

This is a projection over the existing Topic owner, not a new store.
...
### LEGACY TOPIC RENDERER — PRODUCTION OWNERSHIP RETIRED

Native Topic 2029 now owns canonical `/topic/:slug` in production. Remaining Legacy Topic code is cleanup/compatibility debt only and must not become a second public owner.
...
### NEXT
6. **DONE / LIVE:** native `/topic/:slug`;
7. **FOUNDATION LIVE:** canonical/meta/robots/OG/WebPage+Breadcrumb structured-data parity; continue measured SEO quality validation;
