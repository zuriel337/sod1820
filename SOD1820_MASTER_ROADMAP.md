...
- **World / Convergence SEO + AI Discovery:** World Discovery + public Beit-Midrash→World cutover are LIVE. `/world` is the discovery hub; `/topic/:slug` remains the canonical public Convergence identity. NOW = capability-aware Topic sitemap parity → public Topic census/indexability audit → native Topic 2029 renderer → canonical/meta/OG/structured-data/AI-readable parity. Detailed execution map: `docs/2029-world-convergence-seo-ai-discovery-plan-v1.md`;
