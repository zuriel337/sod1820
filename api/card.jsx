// ┌─────────────────────────────────────────────────────────────────────────┐
// │ ⚠️ הערה לסשן השני (מצוריאל): אני רוצה **מלכות**.                          │
// │ כשמסדרים את הפעלת הפונקציה (הסיומת .jsx / הקונפיג ב-vercel.json) —        │
// │ חובה לשמור את העיצוב המלכותי כפי שהוא כאן: כתר 👑, מסגרת זהב,            │
// │ רקע סגול-זהב מלכותי, מספר/מילה ענקיים בזהב. אסור לפשט / להחליף בעיצוב     │
// │ "רגיל" כדי "שזה יעבוד". התצוגה האוטומטית של הקישור חייבת להיראות מלכותית  │
// │ בדיוק כמו הכרטיס בדף המספר. 🌳                                            │
// └─────────────────────────────────────────────────────────────────────────┘
//
