...
// public.notify_admin() (admin_alert_direct_law v1), never a direct wa_send()/hardcoded
...
assert.match(healthWatchBody, /perform public\.notify_admin\(/,
  "fn_health_watch alerts must terminate in public.notify_admin() per admin_alert_direct_law v1");
