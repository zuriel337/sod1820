...
// --- additive evidence is namespaced and Analytics-ACKed for forward use ---
assert.match(object, /share_object/, "evidence must live under one namespaced key");
assert.match(telemetry, /ANALYTICS-ACKED/, "the additive key must carry the recorded Analytics ACK boundary");
